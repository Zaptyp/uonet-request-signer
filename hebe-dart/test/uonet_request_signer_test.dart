...
void main() {
  ...
  test('Tests', () {
    final values = getSignatureValues(fingerprint, privateKey, body, fullUrl,
        DateTime.utc(2020, 4, 14, 4, 14, 16));
